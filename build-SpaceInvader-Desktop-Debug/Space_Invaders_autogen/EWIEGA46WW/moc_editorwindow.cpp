...
#include <memory>
#include "../../../SpaceInvader/editorwindow.h"
...
QT_MOC_LITERAL(1, 13, 12), // "drawingSaved"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 23), // "QVector<QVector<bool> >"
QT_MOC_LITERAL(4, 51, 4), // "grid"
QT_MOC_LITERAL(5, 56, 10) // "saveToFile"

    },
    "EditorWindow\0drawingSaved\0\0"
    "QVector<QVector<bool> >\0grid\0saveToFile"
};
...
void EditorWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->drawingSaved((*reinterpret_cast< const QVector<QVector<bool> >(*)>(_a[1]))); break;
        ...
        {
            using _t = void (EditorWindow::*)(const QVector<QVector<bool>> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorWindow::drawingSaved)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void EditorWindow::drawingSaved(const QVector<QVector<bool>> & _t1)
{
