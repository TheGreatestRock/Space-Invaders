...
QT_MOC_LITERAL(3, 21, 30), // "handleColorBulletButtonClicked"
...
QT_MOC_LITERAL(8, 147, 12) // "returnToMain"

    },
    "MenuWindow\0goToMain\0\0"
...
void MenuWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuWindow::goToMain)) {
                *result = 0;
                return;
            }
        }
